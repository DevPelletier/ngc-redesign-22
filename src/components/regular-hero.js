...
const registerContent = {
  ...
  p1: 'Under Health Canada regulations, you must be registered with your chosen LP in order to purchase medicinal cannabis. Don’t worry, we’ve made the process as simple as possible! Start by completing the registration form below:',
...
const ismedcannright = {
  ...
  p1: "For new patients, discovering the world of medical cannabis can be a bewildering experience at times. Don't worry! We're here to provide you with the facts and tools to make an informed decision. ",
